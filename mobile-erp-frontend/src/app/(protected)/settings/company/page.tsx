  ...
  const handleExportExcel = async () => {
    ...
    try {
      ...
      const categories = [
        ...
        { key: 'productCategories', label: 'Product_Categories' },
        { key: 'mobileDevices', label: 'MobileDevices' },
        { key: 'inventory', label: 'Inventory' },
        { key: 'imeiItems', label: 'IMEI_Records' },
        { key: 'sales', label: 'Sales' },
        { key: 'salesDetails', label: 'Sales_Details' },
        { key: 'salesPayments', label: 'Collections_Payments' },
        { key: 'purchases', label: 'Purchases' },
        { key: 'purchaseDetails', label: 'Purchase_Details' },
        { key: 'salesReturns', label: 'Sales_Returns' },
        { key: 'salesReturnDetails', label: 'Sales_Return_Details' },
        { key: 'purchaseReturns', label: 'Purchase_Returns' },
        { key: 'purchaseReturnDetails', label: 'Purchase_Return_Details' },
        { key: 'expenses', label: 'Expenses' },
        { key: 'expenseDetails', label: 'Expense_Details' },
        { key: 'accountHeads', label: 'Chart_Of_Accounts' },
        { key: 'accountCategories', label: 'Account_Categories' },
        { key: 'journalVouchers', label: 'Journal_Vouchers' },
        { key: 'journalEntries', label: 'Journal_Entries' },
        { key: 'contactLedgers', label: 'Contact_Ledgers' },
        { key: 'branches', label: 'Branches' },
        { key: 'employees', label: 'Employees' },
        { key: 'warehouses', label: 'Warehouses' },
        { key: 'brands', label: 'Brands' },
        { key: 'warrantyClaims', label: 'Warranty_Claims' },
        { key: 'productHistories', label: 'Product_Histories' },
        { key: 'branchTransfers', label: 'Branch_Transfers' },
        { key: 'branchTransferDetails', label: 'Branch_Transfer_Details' },
        { key: 'documentSequences', label: 'Document_Sequences' },
        { key: 'warrantyTypes', label: 'Warranty_Types' },
        { key: 'warrantyDurations', label: 'Warranty_Durations' },
        { key: 'warrantyCoverages', label: 'Warranty_Coverages' },
        { key: 'productConditions', label: 'Product_Conditions' },
        { key: 'marketTypes', label: 'Market_Types' }
      ];
